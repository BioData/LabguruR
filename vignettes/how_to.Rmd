...
```{r}
projects <- labguru_list_projects(get_cols = "limited")
projects
```
...
```{r}
project_1 <- labguru_downlaod_project(project_id = 1)
project_1
```
...
```{r}
project_new <- labguru_upload_project(title      = "My new project",
                                      desription = "This project is an analysis of ...",
                                      return     = "all")
project_new
```
