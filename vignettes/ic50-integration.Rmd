...
hts.384(indir     = paste0(dir, "Files"),
        plates    = 2,
...
- 'samples' contains information on the compounds
...
# ASSUMPTION: THERE CAN ONLY BE ONE INGREDIENT
df <- merge(dfs[!nc][[1]], comp, by.x = "coordinates", by.y = "coordinates")

# TEST: INGREDIENT AND COMPOUND SAME LENGTH
